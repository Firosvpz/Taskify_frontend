...
function createRouter(init) {
  ...
  async function startRedirectNavigation(
    ...
    let redirectHistoryAction =
      replace2 === true || redirect3.response.headers.has("X-Remix-Replace")
        ? Action.Replace
        : Action.Push;
    ...
    if (
      redirectPreserveMethodStatusCodes.has(redirect3.response.status) &&
      activeSubmission &&
...
function patchRoutesImpl(
  ...
  let newRoutes = convertRoutesToDataRoutes(
    ...
    [
      ...
      "patch",
      String(
        ((_childrenToPatch = childrenToPatch) == null
          ? void 0
          : _childrenToPatch.length) || "0",
      ),
    ],
    manifest,
  );
...
function isSameRoute(newRoute, existingRoute) {
  ...
  return newRoute.children.every((aChild, i) => {
    ...
    return (_existingRoute$childr = existingRoute.children) == null
      ? void 0
      : _existingRoute$childr.some((bChild) => isSameRoute(aChild, bChild));
  });
}
async function loadLazyRouteModule(route, mapRouteProperties2, manifest) {
  ...
  Object.assign(
    routeToUpdate,
    _extends({}, mapRouteProperties2(routeToUpdate), {
      lazy: void 0,
    }),
  );
}
...
async function callDataStrategyImpl(
  ...
  let loadRouteDefinitionsPromises = matches.map((m) =>
    m.route.lazy
      ? loadLazyRouteModule(m.route, mapRouteProperties2, manifest)
      : void 0,
  );
...
async function convertDataStrategyResultToDataResult(dataStrategyResult) {
  ...
  if (isDeferredData(result)) {
    ...
    return {
      ...
      deferredData: result,
      statusCode:
        (_result$init3 = result.init) == null ? void 0 : _result$init3.status,
      headers:
        ((_result$init4 = result.init) == null
          ? void 0
          : _result$init4.headers) && new Headers(result.init.headers),
    };
  }
  if (isDataWithResponseInit(result)) {
    ...
    return {
      ...
      data: result.data,
      statusCode:
        (_result$init5 = result.init) == null ? void 0 : _result$init5.status,
      headers:
        (_result$init6 = result.init) != null && _result$init6.headers
...
async function resolveNavigationDeferredResults(
  ...
  for (let index = 0; index < entries.length; index++) {
    ...
    let match = matches.find(
      (m) => (m == null ? void 0 : m.route.id) === routeId,
    );
    if (!match) {
      continue;
    }
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = React.createElement(
      React.Fragment,
      null,
      React.createElement("p", null, "💿 Hey developer 👋"),
      React.createElement(
        "p",
        null,
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  if (errors != null) {
    let errorIndex = renderedMatches.findIndex(
      (m) =>
        m.route.id && (errors == null ? void 0 : errors[m.route.id]) !== void 0,
    );
    !(errorIndex >= 0)
      ? true
        ? invariant(
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    return dataRouterState &&
      ...
      ? React.createElement(RenderErrorBoundary, {
...
function RouterProvider(_ref) {
  ...
  let { v7_startTransition } = future || {};
  let optInStartTransition = React2.useCallback(
    (cb) => {
          ...
          React2.createElement(
            ...
            React2.createElement(
              ...
              state.initialized || router.future.v7_partialHydration
                ? React2.createElement(MemoizedDataRoutes, {
...
function BrowserRouter(_ref4) {
  ...
  let setState = React2.useCallback(
    (newState) => {
      v7_startTransition && startTransitionImpl2
        ? startTransitionImpl2(() => setStateImpl(newState))
        : setStateImpl(newState);
    },
    [setStateImpl, v7_startTransition],
  );
...
function useDataRouterContext2(hookName) {
  ...
  !ctx
    ? true
      ? invariant(false, getDataRouterConsoleError2(hookName))
      : invariant(false)
    : void 0;
  return ctx;
}
...
function useFetcher(_temp3) {
  ...
  let { router } = useDataRouterContext2(DataRouterHook2.UseFetcher);
  ...
  !fetcherData
    ? true
      ? invariant(false, "useFetcher must be used inside a FetchersContext")
      : invariant(false)
    : void 0;
  !route
    ? true
      ? invariant(false, "useFetcher must be used inside a RouteContext")
      : invariant(false)
    : void 0;
  !(routeId != null)
    ? true
  ...
  let load = React2.useCallback(
    (href, opts) => {
      !routeId
        ? true
          ? invariant(false, "No routeId available for fetcher.load()")
          : invariant(false)
        : void 0;
        ...
        getKey && basename !== "/"
          ? (location2, matches2) =>
              getKey(
                ...
                _extends3({}, location2, {
                  pathname:
                    stripBasename(location2.pathname, basename) ||
                    location2.pathname,
                }),
                matches2,
              )
...
function useViewTransitionState(to, opts) {
  ...
  let { basename } = useDataRouterContext2(
    DataRouterHook2.useViewTransitionState,
  );
  let path = useResolvedPath(to, {
