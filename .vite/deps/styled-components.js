  ...
  switch (hash(value, length2)) {
    ...
    case 3616:
      if (
        ...
        return ~indexof(value + (children = children[length2].value), "span", 0)
          ? value
          : MS +
              replace(value, "-start", "") +
              value +
...
function I(e, t, n) {
  return (
    void 0 === n && (n = C), (e.theme !== n.theme && e.theme) || t || n.theme
  );
}
...
function le(e, t, n) {
  if ((void 0 === n && (n = false), !n && !ce(e) && !Array.isArray(e)))
    return t;
  if (Array.isArray(t))
    for (var o2 = 0; o2 < t.length; o2++) e[o2] = le(e[o2], t[o2]);
...
function he(t) {
  ...
  return false
    ...
    : new Error(de.apply(void 0, __spreadArray([pe[t]], n, false)).trim());
}
var fe = (function () {
  function e(e2) {
    ...
    (e.prototype.insertRules = function (e2, t) {
      if (e2 >= this.groupSizes.length) {
        for (var n = this.groupSizes, o2 = n.length, r2 = o2; e2 >= r2; )
          if ((r2 <<= 1) < 0) throw he(16, "".concat(e2));
...
var Pe = function (e, t) {
  for (
    var n,
      o2 = (null !== (n = t.textContent) && void 0 !== n ? n : "").split(g),
      r2 = [],
      s2 = 0,
      i2 = o2.length;
    s2 < i2;
    ...
    if (a2) {
      ...
      if (c2) {
        var l2 = 0 | parseInt(c2[1], 10),
          u2 = c2[2];
        0 !== l2 &&
          (we(u2, l2), Ne(e, u2, c2[3]), e.getTag().insertRules(l2, r2)),
          (r2.length = 0);
      } else r2.push(a2);
    }
  }
...
var _e = function (e) {
  for (
    var t = document.querySelectorAll(be), n = 0, o2 = t.length;
    n < o2;
    n++
  ) {
    var r2 = t[n];
    r2 &&
      r2.getAttribute(f) !== m &&
      (Pe(e, r2), r2.parentNode && r2.parentNode.removeChild(r2));
  }
};
function Ce() {
...
var ke = (function () {
  function e(e2, n, o2) {
    ...
    var r2 = this;
    (this.options = __assign(__assign({}, Te), e2)),
      (this.gs = n),
...
function Fe(e) {
  ...
  u2.push(function (e2) {
    e2.type === RULESET &&
      e2.value.includes("&") &&
      (e2.props[0] = e2.props[0].replace(je, n).replace(o2, l2));
  }),
...
function Ye(e) {
  ...
  return import_react.default.createElement(
    $e.Provider,
    { value: d },
    import_react.default.createElement(Le.Provider, { value: u2 }, e.children),
  );
}
var We = (function () {
  function e(e2, t) {
      ...
      ((Array.isArray(i2) && i2.isCss) || re(i2)
        ...
        : ce(i2)
          ? r2.push.apply(
              r2,
              __spreadArray(
                __spreadArray(["".concat(s2, " {")], Je(i2), false),
                ["}"],
                false,
              ),
            )
    ...
    (e.prototype.generateAndInjectStyles = function (e2, t, n) {
      ...
      if (this.isStatic && !n.hash)
        if (
          ...
          var r2 = ae(Xe(this.rules, e2, t, n)),
        ...
        for (
          var a2 = M(this.baseHash, n.hash), c2 = "", l2 = 0;
...
function ot(e) {
  var n = import_react.default.useContext(et),
    r2 = (0, import_react.useMemo)(
      function () {
  ...
  return e.children
    ? import_react.default.createElement(et.Provider, { value: r2 }, e.children)
    : null;
}
var rt = {};
...
function it(e, r2, s2) {
  var i2 = se(e),
    ...
    g2 =
      r2.displayName && r2.componentId
        ...
        : r2.componentId || f2,
    S2 = i2 && a2.attrs ? a2.attrs.concat(d).filter(Boolean) : d,
  ...
  function O2(e2, r3) {
    return (function (e3, r4, s3) {
      var i3 = e3.attrs,
        ...
        h2 = e3.target,
        f3 = import_react.default.useContext(et),
        m3 = Ge(),
        y3 = e3.shouldForwardProp || m3.shouldForwardProp;
      ...
      var v2 = I(r4, f3, c3) || C,
        g3 = (function (e4, n, o2) {
          ...
          return (
            n.className && (s4.className = ie(s4.className, n.className)), s4
          );
        })(i3, r4, v2),
        S3 = g3.as || h2,
        w3 = {};
      ...
      return (
        ...
        (w3.ref = s3),
        (0, import_react.createElement)(S3, w3)
      );
    })(D2, e2, r3);
  }
  O2.displayName = y2;
  ...
  return (
    ...
    P(y2, g2),
    (D2.warnTooManyClasses = /* @__PURE__ */ (function (e2, t) {
      var n = {},
        o2 = false;
      return function (r3) {
...
function lt(t) {
  ...
  var r2 = t;
  return 0 === n.length && 1 === r2.length && "string" == typeof r2[0]
    ? Xe(r2)
    : ct(Xe(at(r2, n)));
}
function ut(n, o2, r2) {
...
var ht = (function () {
  ...
  return (
    (e.prototype.createStyles = function (e2, t, n, o2) {
      var r2 = o2(ae(Xe(this.rules, t, n, o2)), ""),
    ...
    (e.prototype.renderStyles = function (e2, t, n, o2) {
      e2 > 2 && ke.registerId(this.componentId + e2),
...
function ft(n) {
  ...
  var i2 = lt.apply(void 0, __spreadArray([n], r2, false)),
    a2 = "sc-global-".concat($(JSON.stringify(i2))),
    c2 = new ht(i2, a2);
  P(a2);
  var l2 = function (e) {
    var t = Ge(),
      n2 = import_react.default.useContext(et),
      r3 = import_react.default.useRef(
        t.styleSheet.allocateGSInstance(a2),
      ).current;
    return (
      import_react.default.Children.count(e.children) &&
        console.warn(
      ...
      t.styleSheet.server && u2(r3, e, t.styleSheet, n2, t.stylis),
  ...
  function u2(e, n2, o2, r3, s3) {
    if (c2.isStatic) c2.renderStyles(e, b, o2, s3);
      ...
      var i3 = __assign(__assign({}, n2), {
        theme: I(n2, r3, l2.defaultProps),
      });
...
function mt(t) {
  ...
  var r2 = ae(lt.apply(void 0, __spreadArray([t], n, false))),
    s2 = $(r2);
  return new We(s2, r2);
}
function yt(e) {
    ...
    (this._emitSheetCSS = function () {
      ...
      (this.getStyleElement = function () {
        ...
        var s2 =
            (((n = {})[f] = ""),
            (n[y] = v),
            (n.dangerouslySetInnerHTML = { __html: r2 }),
            n),
          i2 = Ce();
        return (
          i2 && (s2.nonce = i2),
      ...
      (this.instance = new ke({ isServer: true })),
      (this.sealed = false);
  }
  return (
