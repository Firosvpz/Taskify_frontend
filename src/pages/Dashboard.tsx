    ...
    return (
        <StyledContainer fluid>
                        ...
                        <Card.Body>
                            <Row className="mb-4">
                                <Col md={6}>
                                    <ChartCard>
                                        <Card.Body>
                                            <h5 className="text-center mb-4">Task Status Distribution</h5>
                                ...
                                <Col md={6}>
                                    <ChartCard>
                                        <Card.Body>
                                            <h5 className="text-center mb-4">Task Status Comparison</h5>
                                            <ResponsiveContainer width="100%" height={200}>
            ...
            <StyledModal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
                ...
                <Modal.Footer>
                    <StyledButton variant="secondary" onClick={() => setShowDeleteModal(false)}>
                        Cancel
                    </StyledButton>
                    <StyledButton variant="danger" onClick={confirmDelete} disabled={loading}>
                        {loading ? <FaSpinner className="fa-spin" /> : 'Delete'}
                    </StyledButton>
                </Modal.Footer>
            </StyledModal>

            <StyledModal show={showLogoutModal} onHide={() => setShowLogoutModal(false)}>
                <Modal.Header closeButton>
                ...
                <Modal.Footer>
                    <StyledButton variant="secondary" onClick={() => setShowLogoutModal(false)}>
                        Cancel
                    </StyledButton>
                    <StyledButton variant="danger" onClick={handleLogout} disabled={loading}>
